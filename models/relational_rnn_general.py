...
class RelationalMemory(nn.Module):
    ...
    def initial_state(self, batch_size, trainable=False):
        ...
        so initialize the matrix to be the identity matrix (010). We then pad or truncate
    ...
    def multihead_attention(self, memory):
        ...
        # 2020 dec. 12 for the debugging!
        # bing: preivously q *= (self.key_size** -0.5)
        # error in-place function, and we cannot do the gradient setting!
    ...
    def forward_step(self, inputs, memory, treat_input_as_matrix=False):
        ...
        if treat_input_as_matrix:
            ...
            # print(inputs.shape)
            # print(self.input_size, self.mem_size)
